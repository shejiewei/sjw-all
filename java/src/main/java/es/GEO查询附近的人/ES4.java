...
public class ES4 {
    ...
    public static void createIndex(String indexName, String indexType) throws IOException {
        Client esClient = new PreBuiltTransportClient(Settings.EMPTY).addTransportAddress(new TransportAddress(InetAddress.getByName("192.168.2.45"),9300));
        // 创建Mapping
    ...
    public static Integer addIndexData100000(String indexName, String indexType) throws UnknownHostException {
        Client client = new PreBuiltTransportClient(Settings.EMPTY).addTransportAddress(new TransportAddress(InetAddress.getByName("192.168.2.45"),9300));
    ...
    public static String obj2JsonUserData(User user) {
        ...
        try {
            ...
            jsonBuild.startObject().field("id", user.getI()).field("name", user.getName()).startArray("location").value(user.getDlon()).value(user.getDlat()).endArray()
                    .endObject();
