...
public abstract class TypeInformation<T> implements Serializable {
	 ...
	 */
	@PublicEvolving
	public Map<String, org.apache.flink.api.common.typeinfo.TypeInformation<?>> getGenericParameters() {
	 ...
	 */
	public static <T> org.apache.flink.api.common.typeinfo.TypeInformation<T> of(Class<T> typeClass) {
		try {
	 ...
	 * @return The TypeInformation object for the type described by the hint.
	 */
	public static <T> org.apache.flink.api.common.typeinfo.TypeInformation<T> of(TypeHint<T> typeHint) {
